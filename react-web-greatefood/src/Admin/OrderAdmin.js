...
export default function OrderAdmin(){
    ...
    const handleCloseModalDel = () => setShowDelete(false);
    const handleShowModalDel = () => setShowDelete(true);
    ...
    const ModalOrder =()=>{
        return(
          ...
          <Modal.Footer>
            ...
            <Button onClick={()=>{handleShow();handleCloseModal()}} variant="success" disabled={dataItem.Status==1}>Xác nhận thanh toán</Button>
            <Button onClick={()=>{handleShowModalDel();handleCloseModal()}} variant="danger">Xóa đơn</Button>
          </Modal.Footer>
        </Modal>
    )};
    const ModalPayment = ()=>{
    ...
    const ModalDelete = ()=>{
        return(
          ...
          <Modal.Footer>
            <Button variant="primary" onClick={handleCloseModalDel}>
              Đóng
            </Button>
            ...
            {rows.map((row,index)=>(
                <tr className="trDetails"  key={row.id}> 
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Item onClick={()=>{handleShowModalDel();setIdhoadon(row.MaHD)}} href="#">
                            Xóa đơn
                        </Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
