...
export default function App() {
  ...
  const footer = ()=>{
    return(
        ...
        <Container>
          <Row>
            ...
            <Col md={3} sm={12}>
              ...
              <a href="https://www.facebook.com/HuuDung15062/"><IoLogoFacebook className="iconcontact" size={28} color="white" /></a>
              <a onClick={()=>{window.open('mailto:Dung.dev2k@gmail.com?subject=Chủ%20đề%20cần%20phản%20hồi&body=Phản%20hồi%20của%20bạn')}} href="#"><SiGmail className="iconcontact" size={28} color="white"/></a>
            ...
            <Col md={4} sm={12}>
              ...
              <ul>
                ...
                <li>
                  <p>Điện thoại : 0347279563 - 0795646909</p>
                </li>
                <li>
                  <p>Email : Dung.dev2k@gmail.com</p>
                </li>
      ...
      <p> Copyright 2022 © Nguyễn Hữu Dũng </p>
      </div>
      </div>
    )
  }
